...
public class manager_home extends AppCompatActivity {
    ...
    Button exit, meal, rent, profile, shout, manage;
    TextView today, monthly;
    private int mealCount=0, monthlyMeal=0, todayMeal=0;
    private double mealFee=0, mealDue=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meal = (Button) findViewById(R.id.meal2);
        rent = (Button) findViewById(R.id.rent2);
        profile = (Button) findViewById(R.id.profile2);
        //shout = (Button) findViewById(R.id.shout2);
        manage = (Button) findViewById(R.id.manage);
        today = (TextView) findViewById(R.id.today2);
        monthly = (TextView) findViewById(R.id.monthly2);
    ...
    public void goToManage(View view) {
        Intent intent = new Intent(this, manage_meal.class);
        intent.putExtra("username", username);
        startActivity(intent);
    }
